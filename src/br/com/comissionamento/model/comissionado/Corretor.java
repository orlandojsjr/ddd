...
public class Corretor implements Comissionado {

	private List<TabelaComissionamento> tabelas;
	
	{
		 tabelas =  new ArrayList<TabelaComissionamento>() {{
			 add(new TabelaComissionamento(new BigDecimal("0.02"), new PeriodoVigencia(new DateTime(2014, 01, 31, 0, 0), new DateTime(2014, 12, 31, 0, 0)))); 
