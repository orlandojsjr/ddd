...
public class Corretora implements Comissionado {
	...
	
	{
		 tabelas =  new ArrayList<TabelaComissionamento>() {{
			 add(new TabelaComissionamento(new BigDecimal("0.05"), new PeriodoVigencia(new DateTime(2014, 01, 31, 0, 0), new DateTime(2014, 12, 31, 0, 0)))); 
			 add(new TabelaComissionamento(new BigDecimal("0.04"), new PeriodoVigencia(new DateTime(2015, 01, 01, 0, 0), new DateTime(2015, 12, 31, 0, 0))));
		 }};
	}
